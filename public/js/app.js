...
/* harmony export */ });
var Card = function Card(product) {
  var imageList = ['https://www.kedasbeautymember.com/img/serum.adf9b938.png', 'https://www.kedasbeautymember.com/img/soap.30d14d9f.png', 'https://www.kedasbeautymember.com/img/gold_jelly.d0083ac8.png', 'https://www.kedasbeautymember.com/img/scrub.6beaf93b.png'];

  var toRupiah = function toRupiah(num) {
    return num.toString().split('').reverse().join('').match(/\d{1,3}/g).join('.').split('').reverse().join('');
  };

  return "<div class=\"card\">\n              <div class=\"card-img\">\n                  <img src=\"".concat(imageList[product.id - 1], "\" alt=\"").concat(product.name, "\">\n              </div>\n              <div class=\"card-body\">\n                  <div class=\"card-title\">").concat(product.name, "</div>\n                  <div class=\"card-price\">Rp").concat(toRupiah(product.price), "</div>\n                  <div class=\"card-buttons\">\n                      <button class=\"btn btn-outline btn-outline-primary\">Beli Langsung</button>\n                      <button class=\"btn btn-primary\">+ Keranjang</button>\n                  </div>\n              </div>\n          </div>");
};
